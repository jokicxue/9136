...
class Gamesystem:
    """
    set a game system contains items and containers
    pick container method
    game table
    """
    def __init__(self, items, containers):
        """
        input all items and containers
        """
    ...
    def pick_container(self):
        """
        ask user to pick container
        """
        while True:
            container_name = input("Enter the name of the container: ")
            for container in self.containers:
                # if container in the containers list
    ...
    def gametable(self):
        ...
        # call pick container method to ask user to pick container
            ...
            while True:
                ...
                if choice == "1":
                    while True:
                        ...
                        # traverse item in the items list
                        for item in self.items:
                            # if choose item name in items list
                            if choose_item == item.item_name:
                                # if add item can add into container is True
                                ...
                                break
                        # or item not in the items list, ask user to try again
                        else:
                            print(f'''"{choose_item}" not found. Try again.''')
                            continue
                        break
                elif choice == "2":
                    # show the item information of the container
...
if __name__ == "__main__":
    # read 2 files, containers and items
